...
COPY --from=builder --chown=nextjs:nodejs /app/scripts/relax-todo-title-case.js ./scripts/relax-todo-title-case.js
...
CMD ["sh", "-c", "node scripts/ensure-status-changed-at.js && node scripts/relax-todo-title-case.js && node scripts/ensure-search-index.js && node server.js"]
